...
class GazeboModel(object):
    def __init__(self, robots_name_list = ['security_rover']):
    ...
    def get_robot_index(self):
        ...
        while not found_all_robot_names:
            ...
            try:
                ...
                if data:
                    # Here we have model_states data, but not guarantee that the modelswe want are there
...
def listener():
    ...
    robots_name_list = ['security_rover']
